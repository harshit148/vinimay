...
import org.xdev100.vinimay.api.model.OrderInputSchema;
import org.xdev100.vinimay.api.model.OrderResponse;
import org.xdev100.vinimay.api.service.OrderService;
import org.xdev100.vinimay.api.service.OrderServiceV2;
...
public class OrderController {
    ...
    public CompletableFuture<ResponseEntity<MessageFromOrderBook>> getOpenOrders(@RequestParam long userId, @RequestParam String market) throws JsonProcessingException {
        ...
        getOpenOrder.setUserId(String.valueOf(userId));
